...
import '../../Screens/Widgets/date_select.dart';
import '../../Screens/Widgets/doctorList.dart';
import '../../Screens/Widgets/time_select.dart';
          ...
          Column(
            children: [
              ...
              doctorList(
                ...
                numRating: widget.doctor.star.toString(),
                subtext: widget.doctor.supText,
              ),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          child: appointment(modlesDoctors: widget.doctor),
                        ),
                      );
                    },
                    child: Container(
