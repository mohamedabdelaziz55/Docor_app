...
class FindDoctor extends StatelessWidget {
  ...
  ModelsDoctors? modelsDoctors;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<_FindDoctorController>(
      init: _FindDoctorController(modelsDoctors),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            leading: IconButton(
          ...
          body: SingleChildScrollView(
            child: Column(children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.to(() => DoctorDetails(doctor: modelsDoctors!));
                },
                child: DoctorList(
                    distance: "800m away",
...
class _FindDoctorController extends GetxController {
  _FindDoctorController(this.modelsDoctors);
  ModelsDoctors? modelsDoctors;
}
